                ...
                <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-4">
                    <div className="flex items-center gap-3 min-w-0">
                        <div className="flex items-center gap-2 shrink-0">
                            <img src="/BIT%20Logo.png" alt="College logo" className="h-10 w-10 object-contain" />
                            <img src="/Mandran%20Logo.png" alt="Mandran logo" className="h-10 w-10 object-contain" />
                        </div>
                        <h1 className="text-3xl font-bold text-sangamam-gold leading-none">சங்கமம்</h1>
                    </div>
                    <button
            ...
            <div className="relative flex min-h-screen flex-col items-center justify-center px-4 py-4">
                <div className="text-center max-w-3xl mb-16">
                    <div className="mb-8 flex items-center justify-center">
                        ...
                        {/* <img src="/Mandran%20Logo.png" alt="logo_error" width="300" height="300" /> */}
                    </div>
