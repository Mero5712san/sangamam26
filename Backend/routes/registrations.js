...
const { registerEvent, getMyRegistrations, markAttendance, getEventRegistrations, getUserRegistrations, getEligibleTeamMembers, getAssignedRegistrations } = require('../controllers/registrationController');
